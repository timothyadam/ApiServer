        ...
        try:
            ...
            if users:
                for user in users_result["data_list"]:
                    ...
                    role_name_query_sql = self.create_get_relation_sql(db_name, "role", "role.name", role_relations,
                                                                       condition=condition)
                    ...
                    group_name_query_sql = self.create_get_relation_sql(db_name, "user_group", "user_group.name", group_relations,
                                                                        condition=condition)
                    ...
                    department_name_query_sql = self.create_get_relation_sql(db_name, "department", "dpt_name as name",
                                                                             department_relations,
                                                                             condition=condition)
